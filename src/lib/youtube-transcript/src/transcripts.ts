...
export class Transcript {
  ...
  async fetch({ preserveFormatting = false }: { preserveFormatting?: boolean } = {}): Promise<FetchedTranscript> {
...
export class TranscriptListFetcher {
  ...
  private _extractCaptionsJson(innertubeData: Record<string, any>, videoId: string): Record<string, any> {
